...
export function esNumeroValido(numero) {
  ...
  for (const l of [3, 2, 1]) {
    if (len >= l && CODIGOS_SET.has(limpio.slice(0, l))) return true;
  }
  return len >= 10;
}
